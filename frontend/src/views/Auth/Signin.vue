                ...
                <form @submit.prevent="handleSubmit">
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      <button
                        type="submit"
                        class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs"
                      >
                        Sign In
                      </button>
                    </div>
...
import { encodeBase64 } from '@/lib/encryption.js'
const email = ref('')
const password = ref('')
...
const handleSubmit = async () => {
    try {
        ...
        localStorage.setItem('userToken', encodeBase64(data.user.accessToken));
        localStorage.setItem('userData', encodeBase64(JSON.stringify(data.user)));
