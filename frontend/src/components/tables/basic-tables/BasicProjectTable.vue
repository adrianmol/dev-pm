        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ project.description }}</p>
            </td>
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ project.companyTransfer?.name }}</p>
            </td>
...
const openDeleteModal = (companyId) => {
    selectedProjectId.value = companyId;
    showModal.value = true;
};


const confirmDelete = async () => {
    const response = await fetch(`api/project/${selectedProjectId.value}/delete`, {
        method: 'DELETE',
        headers: {
    ...
    projects.value = projects.value.filter((company) => company.id !== selectedProjectId.value);
...
const getProjects = async () => {
    ...
    console.log(data);
    projects.value = data?.projectCollection ?? [];
}
</script>
